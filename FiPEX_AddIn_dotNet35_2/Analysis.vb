...
Public Class Analysis
    ...
    Protected Overloads Overrides Sub OnUpdate()
        ...
        If m_UNAExt Is Nothing Then
            m_UNAExt = FiPEX_AddIn_dotNet35_v10_23.FishPassageExtension.GetUNAExt
        End If
    ...
    Protected Overrides Sub OnClick()
        ...
        Using MyForm As New FiPEX_AddIn_dotNet35_v10_23.frmRunAdvancedAnalysis
    ...
    Private Sub ShowProgressForm()
        ...
        ProgressForm = New FiPEX_AddIn_dotNet35_v10_23.frmAnalysisProgress()
    ...
    Protected Sub RunAnalysis()
        ...
        ' Output Form (will replace dockable window)
        Dim pResultsForm3 As New FiPEX_AddIn_dotNet35_v10_23.frmResults_3
        pResultsForm3.Show()
    ...
    End Sub
    Private Sub UpdateSummaryTable(ByRef lRefinedHabStatsList As List(Of StatisticsObject_2), _
                                   ByRef iHabRowCount As Integer, _
                                   ByRef pResultsForm3 As FiPEX_AddIn_dotNet35_v10_23.frmResults_3, _
                                   ByRef iMaxRowIndex As Integer, _
                                   ByRef iBarrIndex As Integer, _
                                   ByRef bColorSwitcher As Boolean, _
                                   ByRef iSinkRowCount As Integer, _
                                   ByRef iBarrRowCount As Integer, _
        ...
        For m = 0 To lRefinedHabStatsList.Count - 1
            ...
            If m = lRefinedHabStatsList.Count - 1 And _
                ...
                pDataGridViewCellStyle.Font = New Font(pResultsForm3.DataGridView1.Font.FontFamily, _
                                                       pResultsForm3.DataGridView1.Font.Size, _
                                                       FontStyle.Bold)
    ...
    Private Sub DCIShellCall(ByVal sDCITableName As String, ByVal sConnectTabName As String, ByRef pFWorkspace As IFeatureWorkspace)
        ...
        '       Analysis command process and resave them as .CSV's (comma 
