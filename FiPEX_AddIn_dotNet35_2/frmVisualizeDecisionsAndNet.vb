...
#End Region
    ...
    Public Function TraceFlowSolverSetup() As ITraceFlowSolver
        ...
        If m_FiPEx Is Nothing Then
            m_FiPEx = FiPEX_AddIn_dotNet35_v10_23.FishPassageExtension.GetExtension()
        End If
        If m_UtilityNetworkAnalysisExt Is Nothing Then
            m_UtilityNetworkAnalysisExt = FiPEX_AddIn_dotNet35_v10_23.FishPassageExtension.GetUNAExt
        End If
